...
namespace Tests
{
    ...
    public class AoCTestCases
    {
        ...
        [TestCase(19, 1, "#ip 0\r\nseti 5 0 1\r\nseti 6 0 2\r\naddi 0 1 0\r\naddr 1 2 3\r\nsetr 1 0 0\r\nseti 8 0 4\r\nseti 9 0 5", "6")]
        [TestCase(20, 1, "^WNE$", "3")]
        [TestCase(20, 1, "^ENWWW(NEEE|SSE(EE|N))$", "10")]
        [TestCase(20, 1, "^ENNWSWW(NEWS|)SSSEEN(WNSE|)EE(SWEN|)NNN$", "18")]
        [TestCase(20, 1, "^ESSWWN(E|NNENN(EESS(WNSE|)SSS|WWWSSSSE(SW|NNNE)))$", "23")]
